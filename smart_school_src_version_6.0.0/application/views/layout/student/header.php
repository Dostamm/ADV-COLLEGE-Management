...
<?php } } ?>
                        ...
                        if ($this->studentmodule_lib->hasActive('Leave Management')) {
                            ?>
                            <li class="treeview <?php echo set_Topmenu('Leave Management'); ?>"><a href="<?php echo base_url(); ?>user/attendence"><i class="fa fa-calendar-check-o ftlayer"></i> <span><?php echo $this->lang->line('attendance'); ?></span></a></li>
                            <?php
                        }
